...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->Manage customer prof...(truncated), OWNER_VAL->sarah, SYSTEM_VAL->profile-management]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug settings.gradle.kts didn't match [config/testcontainers-test-pipeline.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug build.gradle.kts didn't match [config/testcontainers-test-pipeline.yaml] -> excluded
